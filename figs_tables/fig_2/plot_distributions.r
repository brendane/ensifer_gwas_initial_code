...
trait_lab = c('2_Aminoethanol'='Relative Absorbance', 
              ...
              'PC1'='Bioclim Temp. Axis',
              'PC2'='Bioclim Precip. Axis')
...
pdf('trait_distribution_figure_2018-02-26.main.pdf', width=3, height=9)
...
pdf('trait_distribution_figure_2018-02-26.supp.pdf', width=6, height=7.5)
